...
class FeaturePerId
{
  public:
    ...
    FeaturePerId(int _feature_id, int _start_frame,double initial_depth)
        : feature_id(_feature_id), start_frame(_start_frame),
          used_num(0), estimated_depth(-1), solve_flag(0),stereo_depth(initial_depth)
    {
    }
